...
public class MainActivity extends Activity {
    ...
    private static final String PAGE_JS =
            ...
            + "this,arguments)};var n=0,i=!1,o=1,r=\"\",a=0,d=\"\";[\"touchstart\",\"pointerdown\",\"mousedown\",\"keydown\"].f"
            + "orEach(function(e){document.addEventListener(e,c,!0)}),window.__ytlReport=function(){u(document.quer"
            + "ySelector(\"video\"),!1)},window.__ytlNudge=function(){var e=document.querySelector(\".html5-video-play"
            + "er\"),t=document.querySelector(\"video\");try{if(!t||t.paused||t.ended||t.readyState<2||e&&e.classList."
            + "contains(\"ad-showing\"))return!1;var n=Number(t.currentTime);if(!isFinite(n))return!1;var i=n+.25,o=N"
            + "umber(t.duration);if(isFinite(o)){if(o<=.5)return!1;i>=o-.05&&(i=Math.max(0,n-.25))}return!(Math.abs"
            + "(i-n)<.01)&&(e&&\"function\"==typeof e.seekTo?e.seekTo(i,!0):t.currentTime=i,!0)}catch(e){return!1}},d"
            + "ocument.addEventListener(\"play\",m,!0),document.addEventListener(\"playing\",m,!0),document.addEventLis"
            + "tener(\"pause\",function(e){var t=e.target;t&&\"VIDEO\"===t.tagName&&(u(t,!1),!window.__ytlBg||t.ended||"
            + "Date.now()-window.__ytlBg>1e4||(window.__ytlN=(window.__ytlN||0)+1)>8||setTimeout(function(){var e=t"
            + ".play();e&&e.catch&&e.catch(function(){})},150))},!0),document.addEventListener(\"ended\",function(e){"
            + "u(e.target,!0)},!0),y(),setInterval(y,400)}function c(){a=Date.now()}function u(e,t){if(e&&\"VIDEO\"=="
            + "=e.tagName){var n=!e.paused&&!e.ended,i=!n&&(t||Date.now()-a<1200||Date.now()-(window.__ytlUserPause"
            + "||0)<1500),o=(n?\"1\":\"0\")+(i?\"1\":\"0\");if(o!==r){r=o;try{window.YTLiteBridge&&window.YTLiteBridge.onPl"
            + "aybackState(n,i)}catch(e){}}}}function l(e,t){try{var n=e&&\"function\"==typeof e.getVideoData&&e.getV"
            + "ideoData();if(n&&n.video_id)return n.video_id}catch(e){}return location.pathname+location.search+\"|\""
            + "+(isFinite(t.duration)?Math.floor(10*t.duration):\"live\")}function s(e,t){if(!(!t||t.paused||t.ended|"
            + "|e&&e.classList.contains(\"ad-showing\"))){var n=l(e,t);if(window.__ytlPrimed!==n&&d!==n){d=n;var i=0;"
            + "setTimeout(function e(){var t=document.querySelector(\".html5-video-player\"),o=document.querySelector"
            + "(\"video\");o&&l(t,o)===n?window.__ytlNudge()?(window.__ytlPrimed=n,d=\"\"):++i<5?setTimeout(e,500):d=\"\""
            + ":d=\"\"},500)}}}function y(){if(!document.getElementById(\"ytl-css\")){var e=document.head||document.doc"
            + "umentElement;if(e){var t=document.createElement(\"style\");t.id=\"ytl-css\",t.textContent=\"ytm-promoted-"
            + "sparkles-web-renderer,ytm-promoted-video-renderer,ytm-companion-ad-renderer,ytm-ad-slot-renderer,ad-"
            + "slot-renderer,ytm-brand-video-singleton-renderer,#player-ads,.ytp-ad-overlay-container,.ytp-ad-image"
            + "-overlay{display:none!important}\",e.appendChild(t)}}var r=document.querySelector(\".html5-video-playe"
            + "r\"),a=document.querySelector(\"video\");if(r&&a)if(u(a,!1),a.paused||s(r,a),r.classList.contains(\"ad-s"
            + "howing\")){var d=document.querySelector(\".ytp-ad-skip-button,.ytp-ad-skip-button-modern,.ytp-skip-ad-"
            + "button\");d&&d.click(),n||(i=a.muted,o=a.playbackRate,n=1),a.muted=!0,a.playbackRate=16,isFinite(a.du"
            + "ration)&&a.duration>0&&(a.currentTime=a.duration)}else n&&(a.playbackRate=o,a.muted=i,n=0)}function "
            + "m(e){var t=e.target,n=document.querySelector(\".html5-video-player\");t&&\"VIDEO\"===t.tagName&&(u(t,!1)"
            + ",s(n,t))}}();";
